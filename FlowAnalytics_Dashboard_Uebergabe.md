...
- Gate 1 (Anforderungs-Freeze): vor jedem neuen Visual durchführen ✓
...
- M5 (Bug-Doku nach Behebung): Bugs oben dokumentiert ✓
...
*v1.0–v1.2: Single-File HTML · v2.0: Migration auf ES-Module (4 Dateien), core.js API dokumentiert, Visual-Template ergänzt · v2.1: WIPAge Chart (`wipage.js`) als Visual 3 ergänzt*
